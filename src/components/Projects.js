...
const Projects = () => {
  const projectList = [
    ...
    { title: 'HOSPITAL MANAGEMENT SYSTEM', description: 'The Hospital Management System uses React to create a  interface for managing patient records, appointments, Database management for hospital admininstartion', demo: 'Proficient in React js ,Css,SQL' },
